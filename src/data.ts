...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    detalhesLongos: [
      "Preparo das massas de chocolate e baunilha",
      "Recheios para montagem dos bolos",
      "Montagem e decoração detalhada dos sabores: ninho com morango e chocolate, brigadeiro, abacaxi com coco, ninho com morango, ferrero, floresta branca, prestígio e kinder",
      "Técnicas para fazer bolo de andar",
      "Como produzir fatias para venda no delivery",
      "Técnicas de divulgação e venda dos bolos",
      "Precificação e ficha técnica"
    ],
    galeria: [
  ...
  },
  {
    ...
    linkCheckout: "https://combo.cursodocesdanaty.com.br/",
    detalhesLongos: [
      "Preparo das massas de chocolate e baunilha",
      "Recheios para montagem dos bolos",
      "Montagem e decoração detalhada dos sabores: ninho com morango e chocolate, brigadeiro, abacaxi com coco, ninho com morango, ferrero, floresta branca, prestígio e kinder",
    ...
    galeria: [
      "https://lh3.googleusercontent.com/d/1nt0xdBpvYZ9NBgV1ZiTH3dMnfhZ8M4xb",
