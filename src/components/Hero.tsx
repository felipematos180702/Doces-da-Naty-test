    ...
    <section className="relative pt-32 pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-brand-primary/10 text-brand-primary px-4 py-2 rounded-full font-semibold text-sm mb-6 border border-brand-primary/20">
              <Sparkles size={16} />
              <span>Transforme sua paixão em lucro</span>
            </div>
            
            <h1 className="font-serif text-5xl md:text-7xl font-bold leading-tight mb-6 text-brand-secondary">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a 
                href="#cursos" 
                className="flex items-center justify-center gap-2 bg-brand-secondary text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-brand-secondary/90 transition-all shadow-xl"
              >
                Ver Todos os Cursos
                <ArrowRight size={20} />
              </a>
              <div className="flex items-center gap-4 px-4 py-2">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-gray-500">Satisfeitos em todo o Brasil</p>
                </div>
              </div>
            </div>
          </motion.div>
